export const colorMapping: { [name: string]: string } = {
...
export const borderColorMapping: { [name: string]: string } = {
  'if-statement': '#EC3939',
  'for-loop': '#E08834',
  'while-loop': '#50A2D8 ',
  inheritance: '#53EC67',
  'switch-statement': '#C66CFC',
  'do-while-loop': '#dcb62b',
  recursion: '#d94c80',
  ...
  class: '#8ba9e0',
  'try-catch': '#aa6cd9',
  'variable-declaration': '#d0b81f',
  'return-statement': '#48d132',
  pointer: '#e06e6e',
  operator: '#478be6',
  'lambda-function': '#cb7536',
  struct: '#64d964',
